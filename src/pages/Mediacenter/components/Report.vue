<template>
    <div class="report">
        <div class="reportItem" v-for="v in mediacenterDatas" :key="v.mediacenterId">
            <div class="left">
    ...
    export default {
        ...
        methods: {
            getMediacenterData(p = this.$store.state.lang.version) {
                getMediacenter({ 'moduleType': '3', 'status': '1', 'version': p }).then(res => {
